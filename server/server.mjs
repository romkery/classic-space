import { getCurrentInstance as getCurrentInstance$1, reactive, toRef, isRef, inject, defineComponent as defineComponent$1, computed, ref, h, resolveComponent, shallowRef, unref, watchEffect, markRaw, provide, Suspense, Transition, effectScope, toRaw, watch, isReactive, nextTick, onUnmounted, toRefs, mergeProps, withCtx, createVNode, useSSRContext, Fragment as Fragment$1, shallowReactive, capitalize, camelize, readonly, TransitionGroup, withDirectives, resolveDirective, vShow, resolveDynamicComponent, onScopeDispose, warn, toHandlers, vModelDynamic, cloneVNode, createTextVNode, vModelText, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
import { ssrRenderComponent, ssrRenderAttr, ssrRenderSuspense, ssrRenderAttrs } from "vue/server-renderer";
...
const useHomeCardStore = defineStore("counter", () => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_lazy, mergeProps({ "min-height": "100vh" }, _attrs, _cssVars), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="home__info-news animate__animated animate__fadeInUp"${_scopeId}><p${_scopeId}>${replaceWithBr(props.text)}</p><img${ssrRenderAttr("src", props.imgSrc)} alt="card"${_scopeId}></div>`);
          } else {
            return [
              createVNode("div", { class: "home__info-news animate__animated animate__fadeInUp" }, [
                createVNode("p", {
                  innerHTML: replaceWithBr(props.text)
                }, null, 8, ["innerHTML"]),
                createVNode("img", {
                  src: props.imgSrc,
                  alt: "card"
...
const HomeCard_vue_vue_type_style_index_0_lang = "";
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/utils/HomeCard.vue");
...
const _routes = [
  {
    name: "Home",
    path: "/Home",
    file: "/Users/romkery/Documents/WebStormWeb/classic-space/pages/Home.vue",
    children: [],
    meta: meta$2,
    alias: (meta$2 == null ? void 0 : meta$2.alias) || [],
    component: () => import("./_nuxt/Home.16c506b1.js").then((m) => m.default || m)
  },
  {
    name: "News",
    path: "/News",
    file: "/Users/romkery/Documents/WebStormWeb/classic-space/pages/News.vue",
    children: [],
    meta: meta$1,
    alias: (meta$1 == null ? void 0 : meta$1.alias) || [],
    component: () => import("./_nuxt/News.37653d70.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "/Users/romkery/Documents/WebStormWeb/classic-space/pages/index.vue",
    children: [],
    meta,
    alias: (meta == null ? void 0 : meta.alias) || [],
    component: () => import("./_nuxt/index.064d3bdb.js").then((m) => m.default || m)
  }
];
...
function animate$1(el, keyframes, options) {
  ...
  setup(props, _ref) {
    ...
    function animateClick() {
      if (props.noClickAnimation)
        return;
      contentEl.value && animate$1(contentEl.value, [{
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.b2e79072.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default.9dbdf98d.js").then((m) => m.default || m))
};
